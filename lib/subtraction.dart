...
class SubtractionQuizGame extends StatefulWidget {
  @override
  _SubtractionQuizGameState createState() => _SubtractionQuizGameState();
}

class _SubtractionQuizGameState extends State<SubtractionQuizGame> {
  final List<Map<String, dynamic>> questions = [
    {"question": "5 - 3", "options": [2, 3, 4, 1], "answer": 2},
    {"question": "6 - 2", "options": [3, 4, 2, 5], "answer": 4},
    {"question": "8 - 4", "options": [2, 3, 4, 5], "answer": 4},
    {"question": "7 - 1", "options": [6, 5, 7, 8], "answer": 6},
    {"question": "9 - 5", "options": [3, 4, 5, 6], "answer": 4},
    {"question": "10 - 6", "options": [2, 3, 4, 5], "answer": 4},
    {"question": "8 - 3", "options": [4, 5, 6, 7], "answer": 5},
    {"question": "7 - 0", "options": [7, 6, 5, 8], "answer": 7},
  ];
  ...
  void _goToLevel2() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => SubtractionQuizGame(),
      ),
    );
  }
